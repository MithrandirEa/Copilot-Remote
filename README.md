...
│  (navigateur)   │     /ws/mobile       │  copilot.mithrandirea   │     /ws/vscode        │  (Copilot Chat)     │
└─────────────────┘                      └─────────────────────────┘                       └─────────────────────┘
```
...
Aucune installation requise. Ouvrez `https://copilot.mithrandirea.info` dans le navigateur de votre smartphone. La configuration s'effectue à l'écran au premier lancement.
...
|-----------|-------------------|-------------|
| `copilot-remote.serverUrl` | `wss://copilot.mithrandirea.info` | URL WSS du serveur relais |
...
- **URL du serveur** (ex. `wss://copilot.mithrandirea.info`)
