...
- Sous-domaine `<votre-domaine>` → IP du VPS résolu dans le DNS
...
wscat -c wss://<votre-domaine>/ws/mobile
...
> ```bash
> curl -sI https://<votre-domaine>/health | grep -i "strict\|frame\|content-type\|referrer\|permissions\|security"
> ```
